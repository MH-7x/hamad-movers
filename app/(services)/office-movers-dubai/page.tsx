  ...
  return (
    <>
      <main className="overflow-hidden">
        ...
        {/* OFFICE MOVERS IN OTHER EMIRATES */}
        <section className="py-20 bg-muted/50">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="font-hero text-3xl md:text-4xl mb-4">
                Office Moving Services{" "}
                <span className="text-primary">Throughout UAE</span>
              </h2>
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Commercial relocations with minimal downtime across all UAE
                emirates.
              </p>
            </div>
              ...
              {[
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Professional office moving services available
                  </p>
                </a>
              ))}
            </div>
        ...
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Beyond commercial moves, we provide a full range of relocation
                services.
              </p>
            </div>
